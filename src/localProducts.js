export default [
  {
    ...
    price: 12,
    description:
      "Rúško STX 3PLY je vybavené 3-vrstvovým filtrom z netkanej textílie. Napriek skvelým filtračným vlastnostiam je ľahké a priedušné, komfortné nosenie podporujú elastické ušné slučky. Pre maximálnu účinnosť je ústenka doplnená výstuhou v oblasti nosa, ktorú si vytvarujete presne podľa vašich potrieb tak, aby skvele padla kontúram vašej tváre a nikde neodstávala. Materiál neobsahuje sklolaminát ani latex, ktoré by prípadne mohli vyvolávať alergické reakcie. Ústenka Sunway STX 3PLY bola vyrobená podľa normy EN 149 a v balení nájdete 50 kusov. Balenie je nutné zakúpiť celé, ústenky sa nepredávajú samostatne.",
    featured: true,
    ...
    image: {
      ...
      mime: "image/jpg",
      size: "17,5x9,9,5cm",
      url: "/assets/product-images/product-1.jpg",
      provider: "local",
  ...
  },
  {
    ...
    image: {
      ...
      mime: "image/jpg",
      size: "17,5x9,9,5cm",
      url: "/assets/product-images/product-2.jpg",
      provider: "local",
      provider_metadata: null,
  ...
  },
  {
    ...
    image: {
      ...
      mime: "image/jpg",
      size: "17,5x9,9,5cm",
      url: "/assets/product-images/product-3.jpg",
      provider: "local",
      provider_metadata: null,
